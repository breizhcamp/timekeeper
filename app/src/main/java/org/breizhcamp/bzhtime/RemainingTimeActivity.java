 ...
 * @see SystemUiHider
 */
public class RemainingTimeActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.reloadScheduleBtn).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.changeRoomBtn).setOnTouchListener(mDelayHideTouchListener);
    }
